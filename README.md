# react-native-snap-carousel-v2-maintained
...
<!-- [![github release](https://img.shields.io/github/release/seyicoded/react-native-snap-carousel-v2-maintained.svg?style=flat-square)](https://github.com/seyicoded/react-native-snap-carousel-v2-maintained/releases) -->
[![github issues](https://img.shields.io/github/issues/seyicoded/react-native-snap-carousel-v2-maintained.svg?style=flat-square)](https://github.com/seyicoded/react-native-snap-carousel-v2-maintained/issues)
[![github closed issues](https://img.shields.io/github/issues-closed/seyicoded/react-native-snap-carousel-v2-maintained.svg?style=flat-square&colorB=44cc11)](https://github.com/seyicoded/react-native-snap-carousel-v2-maintained/issues?q=is%3Aissue+is%3Aclosed)
[![Issue Stats](https://img.shields.io/issuestats/i/github/seyicoded/react-native-snap-carousel-v2-maintained.svg?style=flat-square&colorB=44cc11)](http://github.com/seyicoded/react-native-snap-carousel-v2-maintained/issues)
...
### 💡 **[Head over there now](https://github.com/seyicoded/react-native-snap-carousel-v2-maintained/blob/master/doc/VERSION_4.md)** to learn more about all the goodness that's coming your way.
...
### 💡 **[Just head there if you're interested](https://github.com/seyicoded/react-native-snap-carousel-v2-maintained/issues/632).**
...
```bash
$ npm install --save react-native-snap-carousel-v2-maintained
```
...
You can also find a more in-depth (read "complex") one in the [`/example` folder](https://github.com/seyicoded/react-native-snap-carousel-v2-maintained/tree/master/example).
...
### :books: [Documentation for "Props, methods and getters"](https://github.com/seyicoded/react-native-snap-carousel-v2-maintained/blob/master/doc/PROPS_METHODS_AND_GETTERS.md)
...
You can choose between the three of them using [the new prop `layout`](https://github.com/seyicoded/react-native-snap-carousel-v2-maintained/blob/master/doc/PROPS_METHODS_AND_GETTERS.md#style-and-animation) and you can modify the default card offset in the 'stack' and 'tinder' layouts with [prop `layoutCardOffset`](https://github.com/seyicoded/react-native-snap-carousel-v2-maintained/blob/master/doc/PROPS_METHODS_AND_GETTERS.md#style-and-animation).
...
* As you can see, the effect had to be inverted on Android. This has to do with [a really annoying Android-specific bug](https://github.com/seyicoded/react-native-snap-carousel-v2-maintained/blob/master/doc/CUSTOM_INTERPOLATIONS.md#android).
* Even though the new layouts have been created with horizontal carousels in mind, they will also work with vertical ones \o/
* :warning: **You should NOT use `stack` or `tinder` layouts if you have a large data set to display.** In order to avoid rendering issues, the carousel will use a `ScrollView` component rather than a `FlatList` one for those layouts (see [prop `useScrollView`](https://github.com/seyicoded/react-native-snap-carousel-v2-maintained/blob/master/doc/PROPS_METHODS_AND_GETTERS.md#behavior)). The tradeof is that you won't benefit from any of `FlatList`'s advanced optimizations. See [this issue](https://github.com/seyicoded/react-native-snap-carousel-v2-maintained/issues/262) for workarounds; or you may want to implement your own [custom interpolation](#custom-interpolations).
...
### :books: [Documentation for "Custom interpolations"](https://github.com/seyicoded/react-native-snap-carousel-v2-maintained/blob/master/doc/CUSTOM_INTERPOLATIONS.md)

Here are a few examples of what can easily be achieved (you can explore [the source code](https://github.com/seyicoded/react-native-snap-carousel-v2-maintained/blob/master/example/src/utils/animations.js) and try it live in [the provided example](https://github.com/seyicoded/react-native-snap-carousel-v2-maintained/tree/master/example)):
...
### :books: [Documentation for "`ParallaxImage` component"](https://github.com/seyicoded/react-native-snap-carousel-v2-maintained/blob/master/doc/PARALLAX_IMAGE.md)
...
### :books: [Documentation for "`Pagination` component"](https://github.com/seyicoded/react-native-snap-carousel-v2-maintained/blob/master/doc/PAGINATION.md)
...
### :books: [Documentation for "Tips and tricks"](https://github.com/seyicoded/react-native-snap-carousel-v2-maintained/blob/master/doc/TIPS_AND_TRICKS.md)

## Known issues

**Make sure to read about the known issues before opening a new one**; you may find something useful.

### :books: [Documentation for "Known issues"](https://github.com/seyicoded/react-native-snap-carousel-v2-maintained/blob/master/doc/KNOWN_ISSUES.md)
...
> For more information, you can read the following notes: ["Android performance"](https://github.com/seyicoded/react-native-snap-carousel-v2-maintained/blob/master/doc/KNOWN_ISSUES.md#android-performance) and ["Unreliable callbacks"](https://github.com/seyicoded/react-native-snap-carousel-v2-maintained/blob/master/doc/KNOWN_ISSUES.md#unreliable-callbacks).
...
- [ ] Add [more examples](https://github.com/seyicoded/react-native-snap-carousel-v2-maintained/issues/257)
...
- [x] Handle device orientation event (see [this note](https://github.com/seyicoded/react-native-snap-carousel-v2-maintained/blob/master/doc/TIPS_AND_TRICKS.md#handling-device-rotation))
- [x] Add RTL support
